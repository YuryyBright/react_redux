// src/components/layouts/DesktopNav.tsx (НОВИЙ ФАЙЛ)
...
const DesktopNav: React.FC = () => {
  return (
    <nav className="hidden lg:flex items-center gap-10">
      {/* --- Ваші оригінальні посилання --- */}
      <Link 
        to="/" 
        className="text-xl font-bold text-gray-700 dark:text-gray-300 hover:text-slate-600 transition-colors"
      >
        Головна
      </Link>
      <Link 
            ...
            <>
              <Popover.Button
                className={`
                  ...
                  group inline-flex items-center gap-2 text-xl font-bold hover:text-slate-600 transition-colors focus:outline-none
                `}
              >
